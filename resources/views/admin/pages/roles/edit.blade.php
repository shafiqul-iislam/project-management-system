    ...
    <div class="max-w-7xl mx-auto px-6 py-10">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                ...
                <p class="text-sm text-slate-500 mt-1">Update role details and permissions.</p>
            </div>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="role_type" id="role_type" required
                                ...
                                <option value="project_manager" {{ $role->role_type == 'project_manager' ? 'selected' : '' }}>Project Manager</option>
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" rows="4"
                                class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none transition"
                                placeholder="Describe the role...">{{ old('description', $role->description) }}</textarea>
